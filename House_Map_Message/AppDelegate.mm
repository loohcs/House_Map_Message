...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //如果要关注网络以及授权验证时间，需设定generalDelegate参数
    BOOL ret = [_mapManager start:@"H8eWI3sCAOvdsqZrL7gy4BCh" generalDelegate:nil];
    if (!ret) {
    ...
    _revealSideVC = [[PPRevealSideViewController alloc] initWithRootViewController:nav];
